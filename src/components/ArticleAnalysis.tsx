...
export function ArticleAnalysis() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      {!isProfileComplete && (
        <Card variant="outline" className="border-amber/50 bg-amber/5">
          <CardContent className="flex items-center gap-3 py-4">
            <AlertTriangle className="h-5 w-5 text-amber" />
            <p className="text-sm text-foreground">
              Complete your profile in the Setup tab for personalized analysis
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <Card variant="elevated">
        <CardHeader>
          ...
          <CardDescription>
            Paste a climate news article to get a personalized, accessible analysis
          </CardDescription>
        </CardHeader>
